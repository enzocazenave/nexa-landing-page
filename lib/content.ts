export const content = {
  hero: {
    label: "Consultoría para dueños de negocios",
  ...
  quien: {
    ...
    paragraphs: [
      ...
      "Pero en algún momento me di cuenta de que trabajaba muchísimo y no veía los resultados que quería. Ni en lo económico, ni en la libertad del día a día.",
      "Un amigo me pidió ayuda. Su negocio estaba a punto de cerrar. Entré, lo leímos juntos, ordenamos lo que había que ordenar y enfocamos el esfuerzo donde realmente importaba.",
      "No solo no cerró. Logró facturaciones récord.",
      "Ahí entendí dos cosas: que me apasionaba genuinamente ayudar a otros a entender y ordenar sus negocios, y que había una enorme cantidad de dueños que necesitaban exactamente eso — alguien que entrara, mirara sin estar metido adentro del problema, y les dijera qué estaba pasando realmente.",
      "Por eso creé NEXA.",
    ],
    credential:
      "Contador público. Especializado en análisis financiero, modelado de negocios y mejora de procesos. Con formación en metodologías ágiles de ejecución.",
    photoNote: {
      instruction:
        'Reemplazar con foto real: <img src="foto-juanpablo.jpg" alt="Juan Pablo Garay — Fundador de NEXA">',
      requirements: [
        "Formato vertical (portrait)",
        "Fondo neutro o contexto de trabajo real",
        "Cercana, natural — no corporativa",
        "Sin traje ni escritorio genérico",
      ],
    },
  },
  ...
  guarantee: {
    tag: "La llamada",
    title: "La llamada es para entender, no para venderte nada.",
    paragraphs: [
      "30 minutos para hablar de tu negocio, ver qué está pasando hoy y si tiene sentido seguir conversando.",
